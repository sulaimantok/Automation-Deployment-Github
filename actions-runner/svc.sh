...
SVC_NAME="actions.runner.sulaimantok-Automation-Deployment-Github.Al-faruq.service"
SVC_DESCRIPTION="GitHub Actions Runner (sulaimantok-Automation-Deployment-Github.Al-faruq)"
